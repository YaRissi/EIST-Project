...
public class FXMLInterfaceController implements Initializable {
    ...
    // Alle Check Boxen
    @FXML private CheckBox barRestaurantCheckBox;
    @FXML private CheckBox burgerCheckBox;
    @FXML private CheckBox cafeCheckBox;
    @FXML private CheckBox chineseCheckBox;
    @FXML private CheckBox germanCheckBox;
    @FXML private CheckBox greekCheckBox;
    @FXML private CheckBox indianCheckBox;
    @FXML private CheckBox italianCheckBox;
    @FXML private CheckBox japaneseCheckBox;
    @FXML private CheckBox mexicanCheckBox;
    @FXML private CheckBox noodleBarCheckBox;
    @FXML private CheckBox pizzaCheckBox;
    @FXML private CheckBox sushiBarCheckBox;
    @FXML private CheckBox thaiCheckBox;
    @FXML private CheckBox turkishCheckBox;
    @FXML private CheckBox vegeterianCheckBox;

    // Choice Boxen
    @FXML private ChoiceBox<PriceCategory> priceClassChoiceBox;
    @FXML private ChoiceBox<SortingOptions.SortField> sortingFieldChoiceBox;
    @FXML private ChoiceBox<SortingOptions.SortingOrder> sortingOrderChoiceBox;
